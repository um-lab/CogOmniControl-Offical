...
def main():
    ...
    for name, param in transformer3d.named_parameters():
        for trainable_module_name in args.trainable_modules:
            if trainable_module_name in name:
                ...
                break
    model_numel, trainable_model_numel = get_model_numel(transformer3d)
    ...
    if accelerator.is_main_process:
        ...
        save_model(safetensor_save_path, accelerator.unwrap_model(transformer3d))
        if args.save_state:
