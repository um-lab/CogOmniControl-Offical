...
# Custom params
RESUME_FROM_CKPT=""
LORA_PATH=weights/high_noise/Wan2_2-CogOmni_high_lora_connector_14B.safetensors
CONNECTOR_PATH=weights/high_noise/Wan2_2-CogOmni_high_lora_connector_14B.safetensors
...
accelerate launch --config_file ${OUTPUT_BASE_DIR}/config/accelerate_ds_runtime.yaml \
  ...
  --lora_weight=1.0 \
  --caption_mode '[["dense_caption", 0.8], ["caption", 0.2]]' \
  --lora_rank ${LORA_RANK} \
