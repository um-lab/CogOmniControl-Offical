...
from videox_fun.utils.utils import (filter_kwargs, get_image_to_video_latent,
                                    ...
                                    save_videos_grid)
# GPU memory mode, which can be choosen in [model_full_load, model_cpu_offload, model_cpu_offload_and_qfloat8, sequential_cpu_offload].  # model_full_load means that the entire model will be moved to the GPU.
# 
...
model_name          = "models/Diffusion_Transformer/Wan2.1-Fun-14B-Control"
...
vae_path            = None
lora_path           = "exps/20250407_dldl_toon_shadow/output_dir/toon_crop1024_filter/2025.04.11-17.38.01/checkpoint-2200.safetensors"
...
control_video           = "exps/20250407_dldl_toon_shadow/dldl_data/videos/近_crop1024_canny.mp4"
# control_video           = "exps/20250407_douluo_ghibli_style/douluo_data/videos/近_scribble.mp4"
ref_image               = None

# 使用更长的neg prompt如"模糊，突变，变形，失真，画面暗，文本字幕，画面固定，连环画，漫画，线稿，没有主体。"，可以增加稳定性
# 在neg prompt中添加"安静，固定"等词语可以增加动态性。
prompt              = "toon style, anime-style, a man character is walking."
...
# lora_weight             = 2
lora_weight             = 1.5
save_path               = "exps/20250407_dldl_toon_shadow/samples"
